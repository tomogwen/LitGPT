...
A script for [DDP training](https://pytorch.org/tutorials/beginner/ddp_series_theory.html) on Slurm-managed HPC is available. Set the required variables in the [shell script](scripts/slurm.sh), and run:
